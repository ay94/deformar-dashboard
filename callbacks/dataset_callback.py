    ...
    def load_data(n_clicks, dataset_name, model_name, split):
        ...
        if n_clicks > 0:
            if model_name is None:
                ...
                return html.Div(f'Dataset Loaded : {round(dataset_obj.dataset_end_time, 4)} Minutes', style={'color': 'green'})
        else:
    ...
    def initialize_model(n_clicks, dataset_name, model_name, split):
        ...
        if n_clicks > 0:
            if dataset_obj.created:
                ...
                return html.Div(f'Model Created: {round(dataset_obj.create_end_time, 4)} Minute', style={'color': 'green'})
        else:
