    ...
    return dcc.Tab(label='Instance Level Analysis', value="instance", children=[
        ...
        html.Div(
            ...
            children=[
                ...
                html.Button('Visualize Instance', id='visualize_instance', n_clicks=0, style={
        ...
        html.Div(
            ...
            children=[
                ...
                html.Button('Visualize Training Impact', id='visualize_training_impact', n_clicks=0, style={
                    'background-color': '#3DAFA8',
                    'color': 'white',
                    'border': 'none',
                    'padding': '10px 20px',
        ...
        html.Div(
            ...
            children=[
                ...
                html.Button('Load Token Data', id='load_token_data', n_clicks=0, style={
                    'background-color': '#3DAFA8',
                    'color': 'white',
                    'border': 'none',
                    'padding': '10px 20px',
        ...
        html.Div(
            [
                ...
                html.Button('Visualize Example', id='visualize_token_example', n_clicks=0, style={
                    'background-color': '#3DAFA8',
                    'color': 'white',
                    'border': 'none',
                    'padding': '10px 20px',
        ...
        html.Div(id='example-container', children=[
            html.Div([
                html.H3('Label Color Map:'),
        ...
        html.Div(
            children=[
                ...
                html.Button('Compute Example Similarity Matrix', id='compute_example_similarity_matrix', n_clicks=0,
                            style={
                                'background-color': '#3DAFA8',
                                'color': 'white',
                                'border': 'none',
                ...
                dcc.Loading(
                    ...
                    type='default',
                    children=[
                        dcc.Graph(id="example_similarity_matrix", figure=go.Figure()),
                    ]
                ),
        ...
        html.Div(
            children=[
                ...
                html.Button('Compare Example Similarity', id='compare_example_similarity', n_clicks=0,
                            style={
                                'background-color': '#3DAFA8',
                                'color': 'white',
                                'border': 'none',
                ...
                dcc.Loading(
                    ...
                    type='default',
                    children=[
                        dcc.Graph(id="example_compare_similarity", figure=go.Figure()),
                    ]
                ),
