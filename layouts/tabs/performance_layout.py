...
#                                 options=[{"label": "ScatterMode", "value": "group"}],
#                                 value=[],
#                             ),
...
#                             dcc.Checklist(
#                                 id="draw_text",
#                                 options=[{"label": "Draw Text", "value": "draw_text"}],
#                                 value=[],
#                             ),
#                         ],
...
#                     ),
#                     html.H3(
#                         "Selection Token Ambiguity", style={"text-align": "center"}
#                     ),
#                     html.Div(
#                         children=[
#                             dcc.Dropdown(
...
#                     ),
#                     html.H3(
#                         "Selection Token Similarity Matrix",
...
#                             ),
#                             html.Button(
#                                 "Compute Error Similarity Matrix",
#                                 id="compute_error_similarity_matrix",
#                                 n_clicks=0,
#                                 style={
#                                     "background-color": "#3DAFA8",
#                                     "color": "white",
