...
class CorrelationSection:
    def __init__(self, config):
        ...
        self.plot_button = CustomButton('Calculate Correlation', 'calculate_correlation').render()
...
class DatasetTabLayout:
    ...
    def render(self):
        ...
        custom_analysis_container = CustomAnalysisSection(self.dataset_tab_config).render()    
