...
from utils.config_managers import MatrixConfig, DecisionScatterConfig, ScatterConfig
from utils.tab_managers import BasePlotting, create_violin_plot, create_histogram_plot, create_scatter_plot, create_matrix_plot, create_scatter_width_plot, create_scatter_plot_with_color
    ...
    def generate_matrix(self, selected_df, correlation_method):
        ...
        try:
            ...
            config = MatrixConfig(
                ...
                font_color="#000000",
                width=559,  # Slightly larger width for better visibility
                height=500
            )
...
class DecisionScatter(BasePlotting):
    def generate_plot(self, selected_df, x_column, y_column, color_column):
        """
        ...
        #         yaxis_title=y_column,
        #         line_color="#3DAFA8",
        #         marker_color=color_column,
        #         width=800,
        #         height=300,
        #         color_discrete_map=ColorMap.get_color_map()
        #     )

        return create_scatter_plot_with_color(selected_df, x_column, y_column, color_column, scatter_config)
...
class ErrorRateAnalysis(BaseAnalysis):
    ...
    def generate_weighted_error_rate_plot(self, df):
        ...
        # Generate the plot
        error_rate_fig = create_scatter_plot(error_rate_df, tokenization_rate, weighted_error_rate, config)
